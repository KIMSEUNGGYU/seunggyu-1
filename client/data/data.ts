...
const posts: Post[] = [
  {
    ...
    date: "2021.04.07",
    description:
      "스택은 LIFO 구조로 콜스택에서 자주 사용합니다.스택은 LIFO 구조로 콜스택에서 자주 사용합니다.스택은 LIFO 구조로 콜스택에서 자주 사용합니다.스택은 LIFO 구조로 콜스택에서 자주 사용합니다.스택은 LIFO 구조로 콜스택에서 자주 사용합니다.스택은 LIFO 구조로 콜스택에서 자주 사용합니다.스택은 LIFO 구조로 콜스택에서 자주 사용합니다.스택은 LIFO 구조로 콜스택에서 자주 사용합니다.",
    tags: ["자료구조", "스택"],
  },
  {
    id: 2,
